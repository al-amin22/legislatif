        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('pemilih.update', $pemilih->id) }}">
                            @csrf
                            @method('PUT')

                            <div class="form-group">
                                <label for="nik_pemilih">NIK Pemilih</label>
                                <input type="text" class="form-control" id="nik_pemilih" name="nik_pemilih" value="{{ $pemilih->nik_pemilih }}">
                            </div>

                            <div class="form-group">
                                <label for="nama_pemilih">Nama Pemilih</label>
                                <input type="text" class="form-control" id="nama_pemilih" name="nama_pemilih" value="{{ $pemilih->nama_pemilih }}">
                            </div>

                            <div class="form-group">
                                <label for="alamat_pemilih">Alamat Pemilih</label>
                                <input type="text" class="form-control" id="alamat_pemilih" name="alamat_pemilih" value="{{ $pemilih->alamat_pemilih }}">
                            </div>

                            <div class="form-group">
                                <label for="rt_pemilih">RT Pemilih</label>
                                <input type="text" class="form-control" id="rt_pemilih" name="rt_pemilih" value="{{ $pemilih->rt_pemilih }}">
                            </div>
